...
export const MissionsDropDownText = ({modu, grid, imgsrc, margin, img, rubrik, href, header, subText, highImg,  ...props }) => {
...
return (<>
    ...
    ><div>
<h3 className='heading3'>Kategorier och underkategorier Test</h3>
